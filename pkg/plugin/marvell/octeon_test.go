...
func newTestPlugin(t *testing.T) *OcteonPlugin {
	t.Helper()
	return &OcteonPlugin{
		log: logr.Discard(),
	}
...
func TestOcteonPlugin_InitializeAndShutdown(t *testing.T) {
	p := newTestPlugin(t)
...
func TestOcteonPlugin_ShutdownWithoutInit(t *testing.T) {
	p := newTestPlugin(t)
...
func TestOcteonPlugin_HealthCheckWithoutInit(t *testing.T) {
	p := newTestPlugin(t)
...
func TestOcteonPlugin_DiscoverDevicesWithoutInit(t *testing.T) {
	p := newTestPlugin(t)
