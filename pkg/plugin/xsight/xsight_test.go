...
func newTestPlugin(t *testing.T) *XSightPlugin {
	t.Helper()
	return &XSightPlugin{
		log: logr.Discard(),
	}
...
func TestXSightPlugin_InitializeAndShutdown(t *testing.T) {
	p := newTestPlugin(t)
...
func TestXSightPlugin_ShutdownWithoutInit(t *testing.T) {
	p := newTestPlugin(t)
...
func TestXSightPlugin_HealthCheckWithoutInit(t *testing.T) {
	p := newTestPlugin(t)
...
func TestXSightPlugin_DiscoverDevicesWithoutInit(t *testing.T) {
	p := newTestPlugin(t)
